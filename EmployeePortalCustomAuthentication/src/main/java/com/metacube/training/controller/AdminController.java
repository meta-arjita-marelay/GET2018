...
public class AdminController {
	...
	/*
	 * @Autowired ServiceInterface<JobTitle> jobTitleService;
	 */
...
//	}
	...
	@DateTimeFormat(pattern = "yyyy-mm-dd")
	public String addProject(@ModelAttribute("project") Project projectMaster) {
		if (projectMaster != null && projectMaster.getId() == 0) {
			projectService.createProject(projectMaster);
		} else {
