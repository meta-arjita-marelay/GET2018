...
public class QueryFactory {
	...
	public static final String getFriends = "SELECT u.first_name , u.last_name , "
			+ "u.contact_number , u.email_id "
			+ "FROM userDetails u "
			+ "WHERE u.org_name IN "
	...
	public static final String getFriendProfile = "SELECT u.first_name , u.last_name , "
			+ "u.contact_number , u.email_id"
			+ "FROM userDetails u "
			+ "WHERE u.email_id = ? ";
